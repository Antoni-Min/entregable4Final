...
mongoose_1.default.connect(`mongodb+srv://Antoni-Min:${process.env.}@cluster0.xq5kj.mongodb.net/library?retryWrites=true&w=majority`, { useNewUrlParser: true, useUnifiedTopology: true })
    .then(() => {
    // Inicializar server
